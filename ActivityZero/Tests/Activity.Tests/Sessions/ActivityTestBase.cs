...
namespace Activity.Tests.Sessions
{
    public abstract class ActivityTestBase : AbpIntegratedTestBase
    {
        protected ActivityTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<ActivityApplicationModule>();
            modules.Add<ActivityDataModule>();
        }

        public void UsingDbContext(Action<ActivityDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<ActivityDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<ActivityDbContext, T> func)
        {
            T result;
